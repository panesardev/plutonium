...
@Component({
  ...
  template: `
    <div>
      <h1 class="bg-gradient-to-br from-primary to-teal-500 text-3xl font-bold bg-clip-text text-center text-transparent mb-8">Using social</h1>
      <div class="grid max-w-xs gap-6 mx-auto">
        <button class="bg-secondary text-primary" (click)="socialLogin('GOOGLE')">
          <i class="w-6">
        ...
        <button class="bg-secondary text-primary" (click)="socialLogin('GITHUB')">
          <i class="w-6">
...
export class SocialLoginComponent {
  ...
  async socialLogin(providerName: OAuthProviderName) {
