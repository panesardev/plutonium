    ...
    @if (article(); as article) {
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-[400px_1fr] gap-5 md:gap-8 mb-10">
          <img [ngSrc]="article.coverUrl" class="rounded-lg" alt="cover" height="450" width="800" sizes="30vw, 40vw, 50vw" priority>
          <div class="flex flex-col justify-between">
            <div>
              ...
              <div class="flex items-center gap-6 bg-neutral rounded-lg md:rounded-full mb-5 p-4">
...
export class FeaturedArticleComponent {
  ...
  article = toLazySignal(this.articleService.featured$);
